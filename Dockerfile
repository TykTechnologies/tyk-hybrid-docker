...
RUN echo "deb https://packagecloud.io/tyk/tyk-gateway-unstable/debian/ jessie main" | tee /etc/apt/sources.list.d/tyk_tyk-gateway-unstable.list \
 && apt-get update \
 && apt-get install -y --force-yes tyk-gateway \
